                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="mt-2 flex space-x-2">
                            {data.productImage.map((el, index) => (
                                <div key={index} className="relative w-20 h-20 rounded-md overflow-hidden shadow-sm">
                                    <img src={el} alt={`Uploaded-${index}`} className="object-cover w-full h-full" />
                                    <button
                                        type="button"
                    ...
                    <div className="border-t border-gray-200 pt-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-3">
                            <div>
                                <label htmlFor="newCurrency" className="block text-sm font-medium text-gray-700">Currency:</label>
                                <select value={newCurrency} onChange={(e) => setNewCurrency(e.target.value)} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <div>
                                <label htmlFor="newSellingPrice" className="block text-sm font-medium text-gray-700">Rate:</label>
