  ...
  return (
    <div className="fixed inset-0 flex items-start justify-center bg-black bg-opacity-70 p-4 z-50">
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 p-6 rounded-2xl w-full max-w-2xl shadow-2xl mt-10"
        ...
        {productDetails && (
          <>
            <h1 className="text-yellow-400 p-4 font-semibold -mt-6 gap-3 space-y-4">{productDetails._id}</h1>
              ...
              <div className="flex items-center gap-4">
                {productDetails?.productImage?.[0] && (
                  <img
                    ...
                    onClick={() => handleImageClick(productDetails.productImage[0])}
                  />
                )}
                <div>
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <div className="text-gray-200 bg-gray-800 p-3 rounded-lg">{productDetails.totalAmount}</div>
          </div>
          <div>
            <label htmlFor="calculatedTotalAmount" className="block font-medium text-yellow-400 mb-2">Total Amount:</label>
            <div className="text-gray-200 bg-gray-800 p-3 rounded-lg">{productDetails.calculatedTotalAmount}</div>
          </div>
          <div>
            <label htmlFor="userRemark" className="block font-medium text-yellow-400 mb-2">Remarks:</label>
            <div className="text-gray-200 bg-gray-800 p-3 rounded-lg">{productDetails.userRemark}</div>
          </div>
