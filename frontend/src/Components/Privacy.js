              ...
              <Section title="Information We Collect" icon={Eye}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Information You Provide Directly</h4>
                    <p className="text-sm text-gray-300">Information like name, email, phone number, and payment details.</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Transaction Data</h4>
                    <p className="text-sm text-gray-300">Details about the gift cards you sell, such as brand, value, and transaction history.</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Usage Data</h4>
                    <p className="text-sm text-gray-300">Includes your IP address, browser type, pages visited, and timestamps.</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Cookies & Similar Tech</h4>
                    <p className="text-sm text-gray-300">For tracking and improving experience. You can manage this via your browser.</p>
                  </div>
                </div>
              </Section>
              ...
              <Section title="How We Share Your Information" icon={Lock}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="border border-gray-700 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Payment Processors</h4>
                    <p className="text-sm text-gray-300">To complete your transactions securely.</p>
                  </div>
                  <div className="border border-gray-700 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Service Providers</h4>
                    <p className="text-sm text-gray-300">Third parties who assist with hosting, analytics, customer service, etc.</p>
                  </div>
                  <div className="border border-gray-700 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Legal Authorities</h4>
                    <p className="text-sm text-gray-300">When required by law or necessary for protection.</p>
                  </div>
                  <div className="border border-gray-700 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-100 mb-2">Business Transfers</h4>
                    <p className="text-sm text-gray-300">In the event of acquisition or merger, data may be transferred.</p>
                  </div>
                </div>
              </Section>
              ...
              <Section title="Contact Us" icon={Mail}>
                <div className="bg-gradient-to-r from-gray-800 to-gray-700 p-6 rounded-xl border border-yellow-500">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="mailto:secxionapp@gmail.com" className="text-yellow-400 hover:text-yellow-300 font-medium underline">
