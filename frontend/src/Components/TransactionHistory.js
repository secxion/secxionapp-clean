...
import { FaFilter, FaEye, FaEyeSlash, FaHistory, FaSearch, FaTimes, FaChevronUp } from 'react-icons/fa';
...
const TransactionHistory = () => {
    ...
    const displayedTransactions = showAll ? filteredTransactions : filteredTransactions.slice(0, visibleTransactions);
                ...
                <div className="md:hidden mb-4">
                    ...
                    >
                        ...
                        <span className="text-sm text-yellow-400">
                            {menuItems.find(item => item.value === statusFilter)?.label || 'All'}
                        </span>
                    </button>
                </div>
                                        ...
                                        <AnimatePresence mode="wait">
                                            {!showAll ? (
                                                ...
                                                >
                                                    ...
                                                    <span className="hidden md:inline">View All {filteredTransactions.length} Transactions</span>
                                                    <span className="md:hidden">View All ({filteredTransactions.length})</span>
                                                </motion.button>
                                            ) : (
                                                <motion.button
                                                    key="show-less"
