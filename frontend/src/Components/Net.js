...
const Net = ({ blogs }) => {
  ...
  const getContentLength = () =>
    screenSize.isMobile ? 20 : screenSize.isTablet ? 60 : 120;
        ...
        {loading ? (
          <div className="flex items-center space-x-3">
            <div className="flex space-x-1">
              ...
              <div
                className="w-2 h-2 bg-gray-400/70 rounded-full animate-bounce"
          ...
          >
            <div
              className="flex items-center space-x-2 md:space-x-4 cursor-pointer group w-full"
              onClick={() => handleBlogClick(currentBlog)}
            >
              <div className="flex items-center space-x-2 md:space-x-3 flex-shrink-0">
                <div className="relative">
                  <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-yellow-400 rounded-full border border-yellow-600"></div>{' '}
                  {/* Added yellow border */}
