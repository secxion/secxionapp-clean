...
const SecxionShimmer = ({ type = 'card', count = 1 }) => {
  const renderShimmerCard = (index) => (
    <div
      key={index}
      className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 rounded-xl p-6 border border-purple-600/30 shadow-xl"
    >
      {/* Logo header */}
  ...
  const renderShimmerList = (index) => (
    <div
      key={index}
      className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 rounded-lg p-4 border border-purple-600/20"
    >
  ...
  const renderShimmerGrid = (index) => (
    <div
      key={index}
      className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 rounded-xl overflow-hidden border border-purple-600/30 shadow-lg"
    >
