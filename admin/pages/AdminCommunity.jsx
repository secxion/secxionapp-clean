...
const AdminCommunity = () => {
  ...
  // Check if user is authenticated (from localStorage or Redux)
  const isAuthenticated = reduxUser || localStorage.getItem('adminAuth') === 'true';
  ...
  }, [isAuthenticated, fetchPendingPosts]);
