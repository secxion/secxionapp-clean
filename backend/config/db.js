...
async function connectDB(){
    try{
        ...
        console.warn('⚠️  MongoDB Atlas unavailable:', atlasErr.code || atlasErr.message);
        ...
        try {
            ...
            await mongoose.connect('mongodb://localhost:27017/BM12-Section', mongoOptions);
            console.log('✅ Connected to Local MongoDB (Development Mode)');
            console.log('   ⚠️  WARNING: Using local database - changes will NOT sync to Atlas');
