...
export const createReportReplyNotification = async (
  userId,
  reportId,
  message,
  link,
...
export const createMarketUploadNotification = async (
  userId,
  userProductId,
  status,
  productName,
  ...
  try {
    ...
    console.log(
      "createMarketUploadNotification - userProductId:",
      userProductId,
    );
    ...
    console.log(
      "createMarketUploadNotification - newNotification object:",
      newNotification,
    );
    await newNotification.save();
    console.log(
      "createMarketUploadNotification - Notification saved successfully:",
      newNotification,
    );
  } catch (error) {
